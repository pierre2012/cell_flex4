			...
			for entry in bib:
				if entry.has_key('title') and \
				   ...
				   entry.has_key('year'):
                    ...
                    #brett mod here added pages + volume + number above removed below + added pages to append below
					...
					errors['bibliography'] = 'Make sure that the keys title, author and year are present.\n\nBrett: the main reason bibtex will fail to imported is nested parenthesis: make sure you switch title={{GPU}} to title={}'
					break
